 ...
 * @author wangjian.
 */
public class GetJsonContentFromServlet implements ClassFileTransformer {
    /*
            ...
            try {
                ...
                executeUpdateInternal.insertBefore(
                        "com.baidu.openrasp.request.AbstractRequest request = com.baidu.openrasp.HookHandler.requestCache.get();"+
                                "(new com.vipkid.sql.DetectAuthorityVulnClass()).setRequestBody(request.getRequestId(), java.util.Arrays.toString($1));"
                );
